...
public class HashMapStorage implements Cache, CacheUtil 
{
	...
	@Override
	public void readCache(List<String> lst) 
	{
		// TODO Auto-generated method stub
	//	ListIterator<String> itr = lst.listIterator();
		...
		storedbobj.read(lst);
		storefileobj.read(lst);
	}

	@Override
	public void removeCache(List<String> lst) 
	{
		// TODO Auto-generated method stub
		storedbobj.remove(lst);
		storefileobj.remove(lst);

			
	}

	@Override
	public void insertCache(Map<String, ?> params) 
	{
		// TODO Auto-generated method stub
		//Map.Entry<String, ?>
	...
	@Override
	public void updateCache(Map<String, ?> params) 
	{
		// TODO Auto-generated method stub
		//map.put(params.getKey, value)
		/*for (Map.Entry<String, ?> en : params.entrySet())
